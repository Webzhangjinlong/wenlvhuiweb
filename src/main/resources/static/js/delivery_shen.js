...
layui.use(['table', 'form', 'layer', 'vip_table'], function () {
    ...
    var tableIns = table.render({
        ...
        , cols: [
            ...
            , {field: 'totalMoney', title: '提现金额', width: 130 , totalRow: true}
            , {field: 'cDate', title: '提现日期', width: 160}
            ...
            // , {field: '待审核', title: '审核状态', width: 80, sort: true,templet:'getResult'}
    ...
    table.on('tool(delivery_fee)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
        ...
        if (layEvent === 'detail') { //查看
            ...
            var orderIds=data.orderId;
                ...
                $.post('/order/GetMoneys', {"orderId":orderIds,"oi_fee":1}, function(datas){
