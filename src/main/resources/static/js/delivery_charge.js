    ...
    var tableIns = table.render({
        ...
        , cols: [
            [
                ...
                , {field: 'commodity_name', title: '商品名称', width: 400, sort: true}
                , {field: 'commodity_code', title: '商品编码', width: 180, sort: true}
                , {field: 'specification_model', title: '产品成本价', width: 190, sort: true}
                , {field: 'shipping_fee', title: '配送费(元)', width: 180, sort: true}
                , {fixed: 'right', title: '操作', width: 175, align: 'center', toolbar: '#barOption'} //这里的toolbar值是模板元素的选择器
            ]
        ]
        , id: 'dataCheck'
        , url: '/selectDeliveryCharge'
        , method: 'get'
        , page: true
