...
<html>
 		...
 		<div>
			<form class="form-horizontal" role="form"  action="/artist/addImg" id="form1">
		    	...
		    	<div style="margin-top: 10px; margin-left: 530px; margin-top: -50px">
		    		<button class="layui-btn layui-btn-sm" onclick="addImgById(${ addYmArtist.id})">确定添加/修改</button>
	...
	<script type="text/javascript">
        function addImgById(id){
            ...
            window.location.href="/artist/addImg?id="+id+"&imageDetalis="+imageDetalis+"&imgUrl="+imgUrl;
        }
