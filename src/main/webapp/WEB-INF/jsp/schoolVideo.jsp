...
<html>
	...
	<div style="margin-top: 10px">
		...
		<hr style="background: red; height: 2px; margin-top: 0px">
 		...
 		<div>
			<form class="form-horizontal" role="form"  action="/school/addVideo" id="form1">
				<div>
				...
				<div class="layui-upload"  style="margin-left: 20px">
					...
					<div class="layui-upload-list">
						<img class="layui-upload-img" id="demo1" src="${ addSchool.videoImgUrl}">
						<input id="videoImgUrl" name="videoImgUrl" type="hidden" value="${ addSchool.videoImgUrl}"/>
						<p id="demoText"></p>
					</div>
				</div>
				<div class="layui-upload" style="margin-left: 20px;margin-top: 20px">
					...
					<input type="hidden" id="videoUrl" name="videoUrl" value="${ addSchool.videoUrl}" >
		    	...
		    	<div style="margin-top: 10px; margin-left: 530px;">
		    		<button class="layui-btn layui-btn-sm" onclick="addImgById(${ addSchool.id})">确定添加/修改</button>
		    	</div>
			</form>
	...
	<script type="text/javascript">
        function addImgById(id){
            ...
            window.location.href="/school/addVideo?id="+id+"&videoDetails="+videoDetails+"&videoImgUrl="+videoImgUrl+"&videoUrl="+videoUrl;
        }
