 		...
 		<div>
			<form class="form-horizontal" role="form" >
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入匠人名称" disabled>
					</div>
				...
				<label class="control-label">将人介绍:</label><br>
				</div>
				...
				<div class="form-group" style="margin-top: 20px">
					...
					<div class="col-sm-2">
							<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入所在城市" disabled>
					</div>
						<label class="col-sm-1 control-label">区:</label>
						<div class="col-sm-2">
							<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入坐在区县" disabled>
						</div>
				</div>
				<div class="form-group">
			...
			<div style="margin-left: 690px; margin-top: -30px">
				<button class="layui-btn layui-btn-sm layui-btn-normal" onclick="craftsmanShopList()">商品列表</button>
 			</div>
 			<div style="margin-left: 443px; margin-top: -30px">
				<button class="layui-btn layui-btn-sm layui-btn-warm" onclick="craftsmanShopAdd()">添加商品</button>
 			</div>
			</form>
			<div style="margin-left: 690px; margin-top: -30px">
 			</div>
...
<script type="text/javascript">
	function craftsmanShopList(){
		window.location.href="craftsmanShopList.jsp"
	}
</script>
<script type="text/javascript">
