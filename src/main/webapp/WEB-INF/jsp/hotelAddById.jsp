 		...
 		<div>
			<form class="form-horizontal" role="form">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入餐馆名称" disabled>
					</div>
						<label class="col-sm-1 control-label">餐馆类别:</label>
						<div class="col-sm-2">
						<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入餐馆类别" disabled>
					</div>
				...
				<div class="form-group"style="margin-top: 32px">
						...
						<div class="col-sm-2">
							<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入市" disabled>
						</div>
						<label class="col-sm-1 control-label">区:</label>
						<div class="col-sm-2">
							<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入区" disabled>
						</div>
				</div>
				<div class="form-group"style="margin-top: 32px">
						<label class="col-sm-1 control-label">详细地址:</label>
						<div class="col-sm-5">
							<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入详细地址" disabled>
						</div>
				</div>
				<div class="form-group" style="margin-top: 30px">
					<label class="col-sm-1 control-label">经度:</label>
					<div class="col-sm-2">
						<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入经度" disabled>
					</div>
						<label class="col-sm-1 control-label">纬度:</label>
					<div class="col-sm-2">
						<input class="form-control" id="focusedInput" type="text"  value="" placeholder="请输入纬度" disabled>
					</div>
				...
				<div class="form-group" style="margin-top: 30px">
					...
					<div class="col-sm-2">
						<input class="form-control" id="focusedInput" type="text"  value="" placeholder="" disabled>
					</div>
			...
			<div style="margin-left: 690px; margin-top: -30px">
				<button class="layui-btn layui-btn-sm layui-btn-normal" onclick="foodList()">菜品列表</button>
 			</div>
 			<div style="margin-left: 443px; margin-top: -30px">
				<button class="layui-btn layui-btn-sm layui-btn-warm" onclick="foodAdd()">添加菜品</button>
 			</div>
 		</div>
...
<script type="text/javascript">
	function foodList(){
		window.location.href="hotelFoodList.jsp";
	}
</script>
<script type="text/javascript">
	function foodAdd(){
		window.location.href="hotelFoodAdd.jsp";
	}
</script>
</body>
</html>