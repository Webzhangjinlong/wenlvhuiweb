		...
		<hr style="background: red; height: 2px; margin-top: 5px">
 		...
 		<div>
			<form class="form-horizontal" role="form" action="" id="form1">
				...
				<div class="col-sm-2">
					<input class="form-control" id="zcName" type="text"  name="title" value="" placeholder="请输入图书名称">
				</div>
				<label class="col-sm-1 control-label">图书作者:</label>
				<div class="col-sm-2">
					<input class="form-control" id="zcTitleType" type="text"  name="titleType" value="" placeholder="请输入图书作者">
				</div>
			</div>
				<div class="form-group">
					<label class="col-sm-1 control-label">创作时间:</label>
					<div class="col-sm-2">
						<input class="form-control" id="zcName" type="text"  name="title" value="" placeholder="请输入创作时间">
					</div>
					<label class="col-sm-1 control-label">推荐人:</label>
					<div class="col-sm-2">
						<input class="form-control" id="zcTitleType" type="text"  name="titleType" value="" placeholder="请输入推荐人">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-1 control-label">图书价格:</label>
					<div class="col-sm-2">
						<input class="form-control" id="222" type="text"  name="title" value="" placeholder="请输入图书价格">
					</div>
					<label class="col-sm-1 control-label">推荐数量:</label>
					<div class="col-sm-2">
						<input class="form-control" id="333" type="text"  name="titleType" value="" placeholder="请输入推荐数量">
					</div>
				</div>
				<div class="form-group">
						<label class="col-sm-1 control-label">性别爱好:</label>
						<div class="col-sm-2">
						<select class="form-control" id="zcType" name="textType" value="">
											<option value="0" name="textType">--请选择--</option>
											<option value="1" name="textType">男</option>
											<option value="2" name="textType">女</option>
											<option value="3" name="textType">通用</option>
							</select>
						</div>
					<label class="col-sm-1 control-label">大众爱好:</label>
					<div class="col-sm-2">
						<select class="form-control" id="zcStatus" name="status" value="">
							<option value="0" name="status">--请选择--</option>
							<option value="1" name="status">最新</option>
							<option value="2" name="status">最热</option>
							<option value="3" name="status">国外</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select class="form-control" id="111" name="textType" value="">
							<option value="0" name="textType">--请选择--</option>
							<option value="1" name="textType">展示</option>
							<option value="2" name="textType">不展示</option>
						</select>
					</div>
					<label class="col-sm-1 control-label">推荐星级:</label>
					<div class="col-sm-2">
						<select class="form-control" id="" name="status" value="">
							<option value="0" name="status">--请选择--</option>
							<option value="1" name="status">★</option>
							<option value="2" name="status">★★</option>
							<option value="3" name="status">★★★</option>
							<option value="3" name="status">★★★★</option>
							<option value="3" name="status">★★★★★</option>
						</select>
					</div>
				...
				<div class="form-group">
					<label class="col-sm-1 control-label">有货书馆:</label>
					<div class="col-sm-5">
						<input class="form-control" id="222" type="text"  name="title" value="" placeholder="图书馆多个请以，号分隔">
					</div>
				</div>
